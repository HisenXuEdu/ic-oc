...
if __name__ == '__main__':
    ...
    initial_pose = [138.360397,-602.066620,250.361847,-179.488663,0.264109,179.605057]
    ...
    ic.change_para(m=[2, 2, 10, 0.1, 0.1, 0.1], d=[32, 25, 1000, 2, 2, 2], k=[0, 400, 0, 0.5, 0.5, 0.5])
