...
desired_pose_orientation_euler_ = np.array([179.488663/57,0.264109/57,179.605057/57]) 
...
arm_orientation_euler_ = np.array([179.488663/57,0.264109/57,179.605057/57]) 
error = np.zeros(6)
...
def compute_admittance(moving = False):
    ...
    arm_position_ = limit(arm_position_,[-100/1000,-600/1000,350/1000],[400/1000,-350/1000,550/1000])
...
if __name__ == '__main__':
    ...
    if euler:
        while True:
            ...
            wrench_external_ = [-force[1]/10,-force[0]/10,-force[2]/10,force[4],force[3],-force[5]]
            pose, eulur = compute_admittance(moving)
            print(138.360397,-472.066620,407.361847,eulur[0]/57,eulur[1]/57,eulur[2]/57)
            move.ServoP(138.360397,-472.066620,407.361847,eulur[0]*57,eulur[1]*57,eulur[2]*57)
