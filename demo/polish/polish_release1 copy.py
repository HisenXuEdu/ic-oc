...
def generate_move(ic,step):
    i = 1
    while True:
        if ic.desired_pose_position_[1]>-0.48:
            i = -1
...
if __name__ == '__main__':
    ...
    # ic.change_para(m=[2, 2, 4, 0.1, 0.1, 0.1], d=[32, 25, 80, 2, 2, 2], k=[0, 400, 0, 0.5, 0.5, 0.5])
    ic.change_para(m=[2, 2, 10, 0.1, 0.1, 0.1], d=[32, 25, 200, 2, 2, 2], k=[0, 400, 0, 0.5, 0.5, 0.5])
    ...
    while True:
        ...
        move.ServoP(initial_pose[0],pose[1]*1000,pose[2]*1000,euler[0],euler[1],euler[2])
