...
desired_pose_position_ = np.array([-138.360397/1000,-572.066620/1000,407.361847/1000]) 
...
arm_position_ = np.array([-138.360397/1000,-572.066620/1000,407.361847/1000]) 
...
def compute_admittance(moving = False):
    ...
    # arm_desired_twist_adm_ = __limitv(arm_desired_twist_adm_, arm_position_)
    ...
    arm_position_ = limit(arm_position_,[-300/1000,-600/1000,350/1000],[400/1000,-350/1000,550/1000])
    return arm_desired_pose_, arm_orientation_euler_,arm_desired_twist_adm_
...
def __limitv(v, p):
    if p[0]>300/1000:
        # print(v[1],1*math.sqrt(max(-0.35 - p[1],0)))
        v[0] = min(v[0], 1*math.sqrt(max(0.4 - p[0],0)))
...
if __name__ == '__main__':
    ...
    # print(initial_pose)
    initial_pose = [-138.360397,-572.066620,407.361847,179.488663,0.264109,179.605057]
    print(initial_pose)
